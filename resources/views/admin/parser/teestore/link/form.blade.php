<div class="form-group row">
    ...
    <div class="col-4">
        <div class="form-row">
            <label class="col-form-label" for="">ID teestore</label>
            <div class="col">
                <input class="form-control" type="number" placeholder="От" name="id_from" min="1" step="1" value="{{$movie->kp_id or ''}}"/>
            </div>
            <div class="col">
                <input class="form-control" type="number" placeholder="До" name="id_to" min="1" step="1" value="{{$movie->kp_id or ''}}"/>
            </div>
        </div>
        <div class="form-row">
...
<a href="{{route('admin.parser.teestore.index')}}" class="btn btn-outline-success">Отмена</a>