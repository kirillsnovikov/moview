...
window.VueAwesomeSwiper = __webpack_require__(15);
...
Vue.component('swiper-component', __webpack_require__(36));
Vue.component('big-swiper-component', __webpack_require__(39));
Vue.component('search-component', __webpack_require__(42));
Vue.component('menu-component', __webpack_require__(45));
Vue.component('app-component', __webpack_require__(48));
...
Component.options.__file = "resources/assets/js/components/FreemodeSliderComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-310bcab4", Component.options)
  } else {
    hotAPI.reload("data-v-310bcab4", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    filters: {
        raiting: function raiting(value) {
            var raiting = value / 10000;
    ...
    [
      _vm._l(_vm.videos, function(video, index) {
        return _c("swiper-slide", { key: index }, [
          _c("div", { staticClass: "card-slider" }, [
            _c("div", { staticClass: "card-poster" }, [
              _c(
                "a",
                {
                  staticClass: "card-link-poster",
                ...
                [
                  ...
                  _c("div", { staticClass: "card-info" }, [
                    _c("div", [
                      _c("time", { attrs: { datetime: video.premiere } }, [
                        _vm._v(_vm._s(video.premiere))
                      ])
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "card-raiting" }, [
                      _c("div", { staticClass: "flex-row-center" }, [
                        _c("i", { staticClass: "icon-kinopoisk kinopoisk" }),
                        _vm._v(" "),
                        _c("div", [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "card-loader" }, [
            ...
            _c("div", { staticClass: "card-description" }, [
              _c("a", { attrs: { href: _vm.route + "/" + video.slug } }, [
                _c("div", { staticClass: "card-description__title nowrap" }, [
              ...
              _c("a", { attrs: { href: _vm.route + "/" + video.slug } }, [
                _c(
                  ...
                  {
                    staticClass:
                      "card-description__title card-description__title__small nowrap cursive"
                  },
                  [_vm._v(_vm._s(video.original_title))]
                )
              ])
            ])
          ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-310bcab4", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/BigSliderComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-57b56c73", Component.options)
  } else {
    hotAPI.reload("data-v-57b56c73", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    { attrs: { options: _vm.swiperOption } },
    [
      _vm._l(10, function(film, index) {
        return _c("swiper-slide", { key: index }, [
          _c("img", {
            attrs: {
              src: "https://loremflickr.com/1280/266/art/?random=" + index,
              alt: "Постер к фильму",
              title: "Постер к фильму",
              width: "100%"
            }
          })
        ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-57b56c73", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        var input = document.querySelector('input.search-form__input');
        var vm = this;
        document.body.addEventListener('click', function () {
            var searchList = document.querySelector('.search-component>ul.search');
...
var render = function() {
  ...
  return _c("div", { staticClass: "search-component" }, [
    ...
    _vm.isShow
      ? _c(
          "ul",
          { staticClass: "search unstyled", class: { show: _vm.isShow } },
          [
            ...
            _vm._l(_vm.errors, function(error) {
              return _c("li", { staticClass: "small main-color" }, [
                _vm._v(_vm._s(error))
              ])
            })
          ],
...
Component.options.__file = "resources/assets/js/components/MenuComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d319ab7", Component.options)
  } else {
    hotAPI.reload("data-v-7d319ab7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        showMenu: function showMenu() {
            ...
            var rightNav = document.querySelector('.nav>.right-nav');
            if (!this.show && getComputedStyle(menu).display == 'none' && getComputedStyle(rightNav).display == 'none') {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("i", { staticClass: "icon-burger-menu", on: { click: _vm.showMenu } })
  ])
}
var staticRenderFns = []
render._withStripped = true
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        var lazyImages = document.querySelectorAll('img.lazy-load-image');
        var imgLoaders = document.querySelectorAll('.card-loader');
        for (var i = 0; i < lazyImages.length; i++) {
            var img = new Image();
            img.lazyImage = lazyImages[i];
            img.imgLoader = imgLoaders[i];
            img.src = img.lazyImage.getAttribute('data-src');
            img.onload = function () {
                this.lazyImage.parentNode.replaceChild(this, this.lazyImage);
